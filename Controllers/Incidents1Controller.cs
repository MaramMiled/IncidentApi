...
{
    public class Incidents1Controller : Controller
    {
        ...
        // GET: Incidents1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Incidents1/Create
